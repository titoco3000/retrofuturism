export default function Television({ children }) {
  return (
    <div
      className='container h-full relative bg-[#121513] text-[#4af626] font-mono overflow-hidden rounded-2xlshadow-[inset_0_0_60px_rgba(0,0,0,0.9),inset_0_0_20px_rgba(0,0,0,0.7)] crt'
      style={{
        height: '800px',
        filter: 'url("/filter.svg#SphereMapTest")',
      }}
    >
